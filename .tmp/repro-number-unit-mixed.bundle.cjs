...
// repro-number-unit-mixed.ts
var headers = ["\u59D3\u540D", "\u72B6\u6001", "\u5229\u7528\u7387", "\u6210\u672C\u91D1\u989D"];
var rows = [
  ["\u9648\u9ED8", "\u8FDB\u884C\u4E2D", "78%", "\xA52,345"],
  ["\u6797\u6653", "\u5DF2\u5B8C\u6210", "81%", "\xA53,120"]
];
var columnTypes = ["Avatar", "StatusTag", "Text", "Text"];
console.log(JSON.stringify({ inferred: inferColumnTypesFromRows(headers, rows, columnTypes) }));
