...
export interface SemanticLibraryComponentTokenProfile {
  token: string;
  baseToken: string;
}
...
export const SEMANTIC_LIBRARY_COMPONENT_TOKEN_PACK: Record<string, SemanticLibraryComponentTokenProfile> = {
  'library.layout.divider': { token: 'library.layout.divider', baseToken: 'lib-layout-divider' },
  'library.navigation.steps': { token: 'library.navigation.steps', baseToken: 'lib-navigation-steps' },
  'library.navigation.top-nav': { token: 'library.navigation.top-nav', baseToken: 'lib-navigation-top-nav' },
  'library.navigation.anchor': { token: 'library.navigation.anchor', baseToken: 'lib-navigation-anchor' },
  'library.navigation.breadcrumb': { token: 'library.navigation.breadcrumb', baseToken: 'lib-navigation-breadcrumb' },
  'library.navigation.dropdown': { token: 'library.navigation.dropdown', baseToken: 'lib-navigation-dropdown' },
  'library.navigation.header': { token: 'library.navigation.header', baseToken: 'lib-navigation-header' },
  'library.navigation.menu': { token: 'library.navigation.menu', baseToken: 'lib-navigation-menu' },
  'library.navigation.pagination': { token: 'library.navigation.pagination', baseToken: 'lib-navigation-pagination' },
  'library.feedback.drawer': { token: 'library.feedback.drawer', baseToken: 'lib-feedback-drawer' },
  'library.feedback.alert': { token: 'library.feedback.alert', baseToken: 'lib-feedback-alert' },
  'library.feedback.message': { token: 'library.feedback.message', baseToken: 'lib-feedback-message' },
  'library.feedback.modal': { token: 'library.feedback.modal', baseToken: 'lib-feedback-modal' },
  'library.feedback.modal-confirm': { token: 'library.feedback.modal-confirm', baseToken: 'lib-feedback-modal-confirm' },
  'library.feedback.notification': { token: 'library.feedback.notification', baseToken: 'lib-feedback-notification' },
  'library.feedback.popconfirm': { token: 'library.feedback.popconfirm', baseToken: 'lib-feedback-popconfirm' },
  'library.feedback.progress-line': { token: 'library.feedback.progress-line', baseToken: 'lib-feedback-progress-line' },
  'library.basic.button': { token: 'library.basic.button', baseToken: 'lib-basic-button' },
  'library.basic.link': { token: 'library.basic.link', baseToken: 'lib-basic-link' },
  'library.data-input.login-form': { token: 'library.data-input.login-form', baseToken: 'lib-data-input-login-form' },
  'library.data-input.autocomplete': { token: 'library.data-input.autocomplete', baseToken: 'lib-data-input-autocomplete' },
  'library.data-input.button': { token: 'library.data-input.button', baseToken: 'lib-data-input-button' },
  'library.data-input.cascader': { token: 'library.data-input.cascader', baseToken: 'lib-data-input-cascader' },
  'library.data-input.checkbox': { token: 'library.data-input.checkbox', baseToken: 'lib-data-input-checkbox' },
  'library.data-input.checkbox-group': { token: 'library.data-input.checkbox-group', baseToken: 'lib-data-input-checkbox-group' },
  'library.data-input.datepicker': { token: 'library.data-input.datepicker', baseToken: 'lib-data-input-datepicker' },
  'library.data-input.datetimepicker-segemented': { token: 'library.data-input.datetimepicker-segemented', baseToken: 'lib-data-input-datetimepicker-segemented' },
  'library.data-input.drag': { token: 'library.data-input.drag', baseToken: 'lib-data-input-drag' },
  'library.data-input.form': { token: 'library.data-input.form', baseToken: 'lib-data-input-form' },
  'library.data-input.horizontal-form': { token: 'library.data-input.horizontal-form', baseToken: 'lib-data-input-horizontal-form' },
  'library.data-input.image': { token: 'library.data-input.image', baseToken: 'lib-data-input-image' },
  'library.data-input.input': { token: 'library.data-input.input', baseToken: 'lib-data-input-input' },
  'library.data-input.inputgroup': { token: 'library.data-input.inputgroup', baseToken: 'lib-data-input-inputgroup' },
  'library.data-input.inputnumber': { token: 'library.data-input.inputnumber', baseToken: 'lib-data-input-inputnumber' },
  ...
  'library.data-input.switch': { token: 'library.data-input.switch', baseToken: 'lib-data-input-switch' },
  'library.data-input.textarea': { token: 'library.data-input.textarea', baseToken: 'lib-data-input-textarea' },
  'library.data-input.timepicker': { token: 'library.data-input.timepicker', baseToken: 'lib-data-input-timepicker' },
  'library.data-input.timepicker-menu': { token: 'library.data-input.timepicker-menu', baseToken: 'lib-data-input-timepicker-menu' },
  'library.data-input.transfer': { token: 'library.data-input.transfer', baseToken: 'lib-data-input-transfer' },
  'library.data-input.treeselect': { token: 'library.data-input.treeselect', baseToken: 'lib-data-input-treeselect' },
  'library.data-input.vertical-form': { token: 'library.data-input.vertical-form', baseToken: 'lib-data-input-vertical-form' },
  'library.data-display.card-pic': { token: 'library.data-display.card-pic', baseToken: 'lib-data-display-card-pic' },
  'library.data-display.avatar-editable': { token: 'library.data-display.avatar-editable', baseToken: 'lib-data-display-avatar-editable' },
  'library.data-display.add-tag': { token: 'library.data-display.add-tag', baseToken: 'lib-data-display-add-tag' },
  'library.data-display.avatar': { token: 'library.data-display.avatar', baseToken: 'lib-data-display-avatar' },
  'library.data-display.avatargroop': { token: 'library.data-display.avatargroop', baseToken: 'lib-data-display-avatargroop' },
  'library.data-display.avataricon': { token: 'library.data-display.avataricon', baseToken: 'lib-data-display-avataricon' },
  'library.data-display.badge': { token: 'library.data-display.badge', baseToken: 'lib-data-display-badge' },
  'library.data-display.badge-avatar': { token: 'library.data-display.badge-avatar', baseToken: 'lib-data-display-badge-avatar' },
  'library.data-display.calendar': { token: 'library.data-display.calendar', baseToken: 'lib-data-display-calendar' },
  'library.data-display.card': { token: 'library.data-display.card', baseToken: 'lib-data-display-card' },
  ...
  'library.data-display.status-tag': { token: 'library.data-display.status-tag', baseToken: 'lib-data-display-status-tag' },
  'library.data-display.table': { token: 'library.data-display.table', baseToken: 'lib-data-display-table' },
  'library.data-display.tableexpand': { token: 'library.data-display.tableexpand', baseToken: 'lib-data-display-tableexpand' },
  'library.data-display.tablefixation': { token: 'library.data-display.tablefixation', baseToken: 'lib-data-display-tablefixation' },
  'library.data-display.tabs': { token: 'library.data-display.tabs', baseToken: 'lib-data-display-tabs' },
  'library.data-display.tag': { token: 'library.data-display.tag', baseToken: 'lib-data-display-tag' },
  ...
  'library.misc.safety-tag': { token: 'library.misc.safety-tag', baseToken: 'lib-misc-safety-tag' },
  'library.ai.ai-accept': { token: 'library.ai.ai-accept', baseToken: 'lib-ai-ai-accept' },
  'library.ai.ai-button': { token: 'library.ai.ai-button', baseToken: 'lib-ai-ai-button' },
  'library.ai.ai-card': { token: 'library.ai.ai-card', baseToken: 'lib-ai-ai-card' },
  'library.ai.ai-chat-editor': { token: 'library.ai.ai-chat-editor', baseToken: 'lib-ai-ai-chat-editor' },
  'library.ai.ai-feedback': { token: 'library.ai.ai-feedback', baseToken: 'lib-ai-ai-feedback' },
  'library.ai.ai-modal': { token: 'library.ai.ai-modal', baseToken: 'lib-ai-ai-modal' },
  'library.ai.ai-popconfirm': { token: 'library.ai.ai-popconfirm', baseToken: 'lib-ai-ai-popconfirm' },
  'library.ai.ai-progressbar': { token: 'library.ai.ai-progressbar', baseToken: 'lib-ai-ai-progressbar' },
  'library.ai.ai-search': { token: 'library.ai.ai-search', baseToken: 'lib-ai-ai-search' },
