...
> 📚 **文档导航：** 本文件是开发 AI 的行为规范入口。完整的工程规范文档在 [`docs/for-dev-ai/README_CN.md`](docs/for-dev-ai/README_CN.md)，运行时 AI 规范在 [`docs/for-runtime-ai/README_CN.md`](docs/for-runtime-ai/README_CN.md)。
